...
static WGPUDevice wpu_device = nullptr;
...
static void main_loop_step(void* window);
static bool init_web_gpu(GLFWwindow* window);
static void print_glfw_error(int error, const char* description);
static void print_web_gpu_error(WGPUErrorType error_type, const char* message,
        void*);
...
static bool init_web_gpu(GLFWwindow* window)
{
    ...
    wgpu_preferred_fmt = wgpuSurfaceGetPreferredFormat(wgpu_surface, wgpu_adapter);
    ...
    wpu_device = RequestDevice(wgpu_adapter, &device_desc);
#else
    ...
    wgpuDeviceSetUncapturedErrorCallback(wpu_device, print_web_gpu_error, nullptr);
...
static void main_loop_step(void* window)
{
    ...
    if (width!=wgpu_swap_chain_width && height!=wgpu_swap_chain_height) {
        ...
        wgpu_swap_chain =
                wgpuDeviceCreateSwapChain(wpu_device, wgpu_surface, &swap_chain_desc);
    ...
    WGPUCommandEncoder encoder =
            wgpuDeviceCreateCommandEncoder(wpu_device, &enc_desc);
    ...
    WGPUQueue queue = wgpuDeviceGetQueue(wpu_device);
...
static void print_web_gpu_error(WGPUErrorType error_type, const char* message, void*)
{
